        ...
        if not self._fc_lock.locked():  # if not already blocking
            async with self._fc_lock:  # block any other sending tries
                ...
                if retry_after >= 60:
                    ...
                    await self.create_account(short_name='RSStT', author_name='Generated by YemenHR RSS Bot',
                                              author_url='https://github.com/EngDawood/yemenhr-rss-bot')
        ...
        for token in self.tokens:
            ...
            try:
                if len(token) != 60:  # must be an invalid token
                    ...
                    await account.create_account(short_name='RSStT', author_name='Generated by YemenHR RSS Bot',
                                                 author_url='https://github.com/EngDawood/yemenhr-rss-bot')
...
class TelegraphIfy:
    ...
    async def generate_page(self):
        ...
        if self.feed_title:
            ...
            self.telegraph_author = 'Generated by YemenHR RSS Bot'
            self.telegraph_author_url = 'https://github.com/EngDawood/yemenhr-rss-bot'

        self.telegraph_title = self.title or 'Generated by YemenHR RSS Bot'
        self.telegraph_html_content = (soup.decode() +
                                       '<p>Generated by '
                                       '<a href="https://github.com/EngDawood/yemenhr-rss-bot">YemenHR RSS Bot</a>. '
